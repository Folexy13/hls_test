...
function Podcasts() {
    ...
    const fetchPodcasts = async () => {
        try {
            ...
            setFileList(response.data.results); // Assuming your API returns {results: [], count: X}
...
// Add this useEffect to refetch when pagination changes
    useEffect(() => {
        fetchPodcasts();
                    ...
                    {filteredPodcasts.length > 0 ? (
                        <>
                            ...
                            <Pagination
                                ...
                                onChange={(page: any, pageSize: number) => setPagination({
                                    current: page,
                                    pageSize,
                                    total: pagination.total
                                })}
